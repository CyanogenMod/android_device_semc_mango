...
#touch
adb pull /system/etc/firmware/touch_mango_sony_type1.hex ../../../vendor/$VENDOR/$DEVICE/proprietary
adb pull /system/etc/firmware/touch_mango_sony_type2.hex ../../../vendor/$VENDOR/$DEVICE/proprietary
